window.onload = function(){
    ...
    let buttonGreen = create_elem('input',"",{"type":"button","onclick":"setColor('green')","value":"Párrafos verdes"})
    let buttonResetColor = create_elem('input',"",{"type":"button","onclick":"setColor('#000000')","value":"Desactivar color"})
    ...
    document.body.append(buttonCount,buttonShowAll,buttonShowAllP,buttonGreen,buttonResetColor,alertDiv)
